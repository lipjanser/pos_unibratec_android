...
//import br.com.android.fjanser.hotspotz.widget.MovieWidget;
//import br.com.android.fjanser.hotspotz.widget.MovieWidgetService;

public class HotSpotProvider extends ContentProvider {

    private static final String PATH = "hotspot";
    private static final String AUTHORITY = "br.com.android.fjanser.hotspotz.hotspot";
    ...
    public static Uri HOTSPOT_URI = BASE_URI.withAppendedPath(BASE_URI, PATH);
    ...
    public Uri insert(Uri uri, ContentValues values) {
        ...
        if (uriType == TYPE_GENERIC){
            ...
            long id = db.insert(HotSpotContract.TABLE_NAME, null, values);
            db.close();
            ...
            notifyChanges(uri);
            //notifyWidget();
            return ContentUris.withAppendedId(HOTSPOT_URI, id);
    ...
    public Cursor query(Uri uri, String[] projection, String selection,
        ...
        switch (uriType){
            ...
            case TYPE_GENERIC:
                cursor = db.query(HotSpotContract.TABLE_NAME,
            ...
            case TYPE_ID:
                long id = ContentUris.parseId(uri);
                cursor = db.query(HotSpotContract.TABLE_NAME,
                        projection, HotSpotContract._ID +" = ?",
